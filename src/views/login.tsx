...
export default function LoginView() {
  return (
    <div className="flex flex-col md:flex-row h-screen  text-black mt-10">
          ...
          <form className="space-y-4">
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3 text-sm">
                <label htmlFor="keep-logged" className="text-gray-700">
            ...
            <button
              type="submit"
              className="bg-black text-white w-full border border-gray-500 py-3 flex items-center justify-between px-4 rounded-lg"
            >
              EMAIL LOGIN
              <svg
      ...
      <div className="w-full md:w-1/2 p-8 bg-gray-100 flex items-center rounded-4xl h-[500px] ">
        <div className="">
          ...
          <button className="bg-black text-white px-4 py-3 rounded flex items-center justify-between w-full">
            JOIN THE CLUB
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
